  ...
  return (
    <div key={provider.name}>
      <StyledLoadingButton
        ...
        variant="contained"
        startIcon={isMediumScreen ? undefined :  <img src="/google.svg" alt="Google" style={{height: "1.5rem", width: "1.5rem"}}/> }
        {...rest}
      >
        {isMediumScreen ? (
           <img src="/google.svg" alt="Google" style={{height: "1.5rem", width: "1.5rem"}}/>
        ) : (
