...
export default function Chart(props: {
  ...
  const openData = splitDataByMonth(props.openEnquiries, currMonth, currYear);
  const closedData = splitDataByMonth(props.closedEnquiries, currMonth, currYear);
  const lineData = getLineData(props.openEnquiries.length, openData, closedData);
