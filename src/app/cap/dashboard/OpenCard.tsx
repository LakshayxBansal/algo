...
export default async function OpenCard() {
    let result, openEnquiriesCount;
    const date = new Date();
    try {  
        result = await getOpenEnquiriesCount();
        openEnquiriesCount = result.total
    } catch (e) {
        console.log(e);
    } 
    return (
        ...
        >
            ...
            <Box>
                ...
                <Typography component="p" variant="h4">{openEnquiriesCount}</Typography>
