...
export default function InputForm(props: { baseData: IformData }) {
  ...
  return (
    <ThemeProvider theme={theme}>
      <form>
        <Paper style={{ minHeight: "100vh", minWidth: "100vh" }}>
          <Grid
            container
            spacing={1}
            ...
            <Grid item xs={11}>
              ...
              >
                ...
                <InputControl
                  ...
                  name="date"
                />
                <SelectMasterWrapper<optionsDataT>
                  name={"contact"}
                  id={"contact"}
                  label={"Contact"}
                  dialogTitle={"Add Contact"}
                  renderOptions={(option: optionsDataT) => {
                    return option.name + " " + option.id;
                  }}
                  labelOptions={(option: optionsDataT) => {
                    return "" + option.id;
                  }}
                  highlightOptions={(option: optionsDataT) => {
                    return option.name + "-highlight- " + option.id;
                  }}
                  ...
                  onChange={(e, val, setDialogVal) => {
                    console.log("external onchange hook");
                  }}
                />
              </Box>
              <Box
              ...
              <Grid item xs={12} md={12}>
                <Grid item xs={6} md={12}>
                  <TextField
                    ...
                    multiline
                    name="callReceiptRemarks"
                    id="callReceiptRemarks"
                    rows={6}
                    fullWidth
                  />
                </Grid>
              ...
              <Grid item xs={12} md={12}>
                <Grid item xs={6} md={12}>
                  <TextField
                    ...
                    multiline
                    name="suggestedActionRemarks"
                    id="suggestedActionRemarks"
                    rows={6}
                    fullWidth
                  />
                </Grid>
