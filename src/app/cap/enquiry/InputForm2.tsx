  ...
  props.baseData.fields.map((field: any, index) => {
    if (field.is_default_column) {
      if (field.column_name_id === "product_grid") {
              ...
              >
                <Grid item xs={12} md={12} key={`call-receipt-grid-${index}`}>
                  <TextField
                    ...
                    fullWidth
                    required={
                      fieldPropertiesById("call_receipt_remark").required
                    }
                  />
                </Grid>
                <Grid
                ...
                >
                  <TextField
                    ...
                    fullWidth
                    required={
                      fieldPropertiesById("suggested_action_remark").required
                    }
                  />
                </Grid>
              </Grid>
        ...
        // if (field.column_name_id === "status") {
        //   const fld = React.cloneElement(baseElement, {
        //     ...baseElement.props,
        //     // children[0].props.label: field.column_label,
        //   });
        //   console.log(fld);
        // }
        const fld = React.cloneElement(baseElement, {
