...
export default function EnquiryConfigForm(props: configT) {
    ...
    checkBoxData: [
      {
        ...
        checked: (props.enquiryCloseCall as boolean) ?? false,
        group: "enquiryCloseCall",
        disable: props.enquiryReqd,
      },
      {
        id: "enquiryMaintainProducts",
        name: "enquiryMaintainProducts",
        custLabel: "Maintain Products in Call Receipt",
        checked: (props.enquiryMaintainProducts as boolean) ?? false,
      ...
      },
      {
        ...
        checked: (props.enquirySaveFAQ as boolean) ?? false,
      ...
      },
      {
        ...
        checked: (props.enquiryMaintainAction as boolean) ?? false,
      ...
      },
      {
        ...
        checked: (props.enquiryVoucherNumber as boolean) ?? false,
    ...
    checkBoxData: [
      {
        ...
        custLabel: "Can Close Call at the time of Call Receipt",
        checked: (props.supportCloseCall as boolean) ?? false,
        group: "supportCloseCall",
        disable: props.supportReqd,
      },
      {
        id: "supportMaintainProducts",
        name: "supportMaintainProducts",
        custLabel: "Maintain Products in Call Receipt",
        checked: (props.supportMaintainProducts as boolean) ?? false,
      ...
      },
      {
        ...
        name: "supportSaveFAQ",
        custLabel: "Ask to Save FAQ on Call Receipt and Report Saving",
        checked: (props.supportSaveFAQ as boolean) ?? false,
      ...
      },
      {
        ...
        custLabel: "Maintain Action Taken for Call Receipt",
        checked: (props.supportMaintainAction as boolean) ?? false,
      ...
      },
      {
        ...
        custLabel: "Do you want to keep Voucher Number?",
        checked: (props.supportVoucherNumber as boolean) ?? false,
    ...
    checkBoxData: [
      {
        ...
        custLabel: "Do you want to keep Voucher Number?",
        checked: (props.contractVoucherNumber as boolean) ?? false,
        group: "contractVoucherNumber",
        disable: props.contractReqd,
      },
    ],
  ...
  const [app, setApp] = useState({
    checkBoxData: [
      {
        id: "appVoucherNumber",
        name: "appVoucherNumber",
        custLabel: "Do you want to keep Voucher Number?",
        checked: (props.regionalSettingVoucherNumber as boolean) ?? false,
        group: "appVoucherNumber",
        disable: props.regionalSettingReqd,
      },
    ],
    ...
    appPrefillWithZero: {
      id: "appPrefillWithZero",
      name: "appPrefillWithZero",
      value: false,
    },
  ...
  const handleEnquiryChange = (name: string, dataType: string, value: any) => {
    if (dataType === "checkBox") {
      ...
      setEnquiry((prev) => ({
        ...prev,
        [name]: { id: name, name: name, value: value },
      }));
    }
  };
  ...
  const handleEnquiryGenerationChange = (
    name: string,
    dataType: string,
    value: any
  ) => {
          ...
          <div>
            <Accordion>
              ...
              <AccordionDetails style={{ marginLeft: "1.3rem" }}>
                <CheckBoxForm
                  fields={enquiry.checkBoxData}
                  type="checkBox"
                  onChange={handleEnquiryChange}
                />
                {enquiry.checkBoxData[enquiry.checkBoxData.length - 1]
                  .checked && (
                  <Dynamic
                    prefix={enquiry.enquiryPrefix}
                    suffix={enquiry.enquirySuffix}
                    length={enquiry.enquiryLength}
                    prefillWithZero={enquiry.enquiryPrefillWithZero}
                    onChange={handleEnquiryChange}
                  />
                )}
              </AccordionDetails>
            ...
            <Accordion>
              ...
              <AccordionDetails style={{ marginLeft: "1.3rem" }}>
                <CheckBoxForm
                  fields={support.checkBoxData}
                  type="checkBox"
                  onChange={handleSupportChange}
                />
                {support.checkBoxData[support.checkBoxData.length - 1]
                  .checked && (
                  <Dynamic
                    prefix={support.supportPrefix}
                    suffix={support.supportSuffix}
                    length={support.supportLength}
                    prefillWithZero={support.supportPrefillWithZero}
                    onChange={handleSupportChange}
                  />
                )}
              </AccordionDetails>
            ...
            <Accordion>
              ...
              <AccordionDetails style={{ marginLeft: "1.3rem" }}>
                <CheckBoxForm
                  fields={contract.checkBoxData}
                  type="checkBox"
                  onChange={handleContractChange}
                />
                {contract.checkBoxData[contract.checkBoxData.length - 1]
                  .checked && (
                  <Dynamic
                    prefix={contract.contractPrefix}
                    suffix={contract.contractSuffix}
                    length={contract.contractLength}
                    prefillWithZero={contract.contractPrefillWithZero}
                    onChange={handleContractChange}
                  />
                )}
              </AccordionDetails>
            ...
            <Accordion>
              ...
              <AccordionDetails style={{ marginLeft: "1.3rem" }}>
                <CheckBoxForm
                  fields={enquiryGeneration.checkBoxData}
                  type="checkBox"
                  onChange={handleEnquiryGenerationChange}
                />
                {enquiryGeneration.checkBoxData[
                  enquiryGeneration.checkBoxData.length - 1
                ].checked && (
                  <Dynamic
                    prefix={enquiryGeneration.enquiryGenerationPrefix}
                    suffix={enquiryGeneration.enquiryGenerationSuffix}
                    length={enquiryGeneration.enquiryGenerationLength}
                    prefillWithZero={
                      enquiryGeneration.enquiryGenerationPrefillWithZero
                    }
                    onChange={handleEnquiryGenerationChange}
                  />
                )}
            ...
            <Accordion>
              ...
              <AccordionDetails style={{ marginLeft: "1.3rem" }}>
                ...
                />
                <CheckBoxForm
                  fields={app.checkBoxData}
                  type="checkBox"
                  onChange={handleAppChange}
                />
                {app.checkBoxData[app.checkBoxData.length - 1].checked && (
                  <Dynamic
                    prefix={app.appPrefix}
                    suffix={app.appSuffix}
                    length={app.appLength}
                    prefillWithZero={app.appPrefillWithZero}
                    onChange={handleAppChange}
                  />
                )}
              </AccordionDetails>
