...
import { getExecutiveDept } from '@/app/controllers/executiveDept.controller';
...
export default function ManageExecutiveDept(props: {
  id: number;
  setDlgValue: Dispatch<SetStateAction<boolean>>;
}) {

  async function handleDelete() {
    await DeleteExecutiveDept(props.id);
