...
export const enquirySupportConfig = z.object({
  ...
  contractReqdPrefix: z.string().optional(),
  contractReqdSuffix: z.string().optional(),
  contractReqdLength: z.string().optional(),
  contractReqdPrefillWithZero: z.boolean().optional(),

  enquiryGenerationReqdVoucherNumber: z.boolean().optional(),
  enquiryGenerationReqdPrefix: z.string().optional(),
  enquiryGenerationReqdSuffix: z.string().optional(),
  enquiryGenerationReqdLength: z.string().optional(),
  enquiryGenerationReqdPrefillWithZero: z.boolean().optional(),

  appReqdVoucherNumber: z.boolean().optional(),
  appReqdPrefix: z.string().optional(),
  appReqdSuffix: z.string().optional(),
  appReqdLength: z.string().optional(),
  appReqdPrefillWithZero: z.boolean().optional(),
