...
export default function ContactForm(props: masterFormPropsT) {
  ...
  async function persistEntity(data: contactSchemaT) {
    ...
    } else result = await createContact(data);
  ...
  return (
    <>
      <Seperator>{entityData ? "Update Contact" : "Add Contact"}</Seperator>
        ...
        <form action={handleSubmit}>
          ...
          >
            ...
            <InputControl
              ...
              phoneValue={entityData ? entityData.mobile : ""}
            />
            <InputControl
              inputType={InputType.PHONE}
              id="whatsapp"
              ...
              phoneValue={entityData ? entityData.whatsapp : ""}
            />
          </Box>
          <Box
            sx={{
