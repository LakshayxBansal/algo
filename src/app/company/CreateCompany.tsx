...
export default function CreateCompany(props: masterFormPropsWithDataT) {
  ...
  //     const ip = await getCountryByIp(req);
  //     console.log("IPP: ", ip);
  // }

  // const data = getCountryByIp(req);
  // async function extractData() {
  //   const resolvedData = await data;
  //   console.log("DATAT: ", data);
  //   console.log("DAdsadsTAT: ", resolvedData);

  // const country = resolvedData.country;
  // const countryId = resolvedData.countryId;

  // console.log("Datattatata: ", country, countryId);
  // }
  return (
    <Paper
      elevation={3}
...
//       const countryId = await getCountryIdByName(defaultCountry);
